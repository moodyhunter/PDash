...
install(DIRECTORY "${Qt6Core_DIR}/../../../plugins/tls/" DESTINATION "$<TARGET_BUNDLE_DIR:PD>/Contents/PlugIns/tls/")

## Destination paths below are relative to ${CMAKE_INSTALL_PREFIX}
install(TARGETS PD BUNDLE DESTINATION .)
...
set(APP "${CMAKE_INSTALL_PREFIX}/PD.app")
...
install(CODE "execute_process(COMMAND \"install_name_tool\" -add_rpath \"@executable_path/../Frameworks\" \"${APP}/Contents/MacOS/PD\")")
